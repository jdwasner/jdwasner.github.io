...
- The "Vol Del" refers to Volume Delta which is the difference between the precent of suspect product that passed through that route vs the precent of process volume that passed through that route
### Corral Module
